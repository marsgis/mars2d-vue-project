// vue内嵌的方式，目前未使用，启用步骤
// 1、注释public\index.html文件的lib/include-lib.js引入
// 2、取消src\main.js对includeLib文件引入的注释
// 3、取消src\components\mars2d\Map.vue的initMars2d前后的注释
...
// 加载类库资源文件
export function load(strlibs) {
  var arrInclude = strlibs.split(',')
  var libpath = window.basePath
